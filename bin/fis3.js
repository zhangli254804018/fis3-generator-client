...
function createApplication(app_name, path) {
    ...
    mkdir(path, function() {
        ...
        mkdir(path + '/assets/stylesheets', function() {
            switch (program.css) {
                case 'less':
                    write(path + '/assets/stylesheets/style.less', less);
                    break;
                case 'stylus':
                    write(path + '/assets/stylesheets/style.styl', compass);
                    break;
                case 'compass':
                    write(path + '/assets/stylesheets/style.scss', compass);
                    break;
                case 'sass':
                    write(path + '/assets/stylesheets/style.sass', sass);
                    break;
                default:
                    write(path + '/assets/stylesheets/style.css', css);
            }
            complete();
        });

        mkdir(path + '/js', function() {
            write(path + '/js/index.js', index);
            complete();
        });
